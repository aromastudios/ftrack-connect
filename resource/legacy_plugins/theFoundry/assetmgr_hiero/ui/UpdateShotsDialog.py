...
class UpdateShotsDialog(QtWidgets.QDialog):
  """
...
class UpdateShotsWidget(QtWidgets.QWidget):
  """
  ...
  def _buildUI(self, layout):
    ...
    parentPickerLayout.addWidget(QtWidgets.QLabel(l("Match {shots} under:")))
  ...
  def _buildShotsTab(self):
    ...
    shotsWidget = QtWidgets.QWidget()
    shotsWidget.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
    shotsWidgetLayout = QtWidgets.QVBoxLayout()
    ...
    self._shotLengthGBox = QtWidgets.QGroupBox("Set Shot Timings")
    self._shotLengthGBox.setCheckable(True)
    self._shotLengthGBox.setChecked(False)
    slGbLayout = QtWidgets.QHBoxLayout()
