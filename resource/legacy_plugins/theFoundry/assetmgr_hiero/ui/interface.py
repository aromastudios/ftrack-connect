...
def buildStaticUI():
  ...
  menu = QtWidgets.QMenu("Asset Management")
...
def _addAssetMenuItems(menu):
  ...
  if 'auditStartAction' in  __actions:
    auditSubMenu = QtWidgets.QMenu("API Audit")
...
def populateTimelineContextMenu(event):
  ...
  submenu = QtWidgets.QMenu(managerName)
  ...
  if not buildTrackMenu:
    ...
    buildTrackMenu = QtWidgets.QMenu("Build Track")
