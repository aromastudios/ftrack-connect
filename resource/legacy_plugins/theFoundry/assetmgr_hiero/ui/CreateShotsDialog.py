...
class CreateShotsWidget(QtWidgets.QWidget):
  """
  ...
  def _buildUI(self, layout):
    ...
    parentPickerLayout.addWidget(QtWidgets.QLabel("Create Under:"))
  ...
  def _buildShotsTab(self):
    ...
    self._shotLengthGBox = QtWidgets.QGroupBox("Set Shot Timings from Hiero")
