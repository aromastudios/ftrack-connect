...
class TrackItemTimingOptionsWidget(QtWidgets.QWidget):
  """
  ...
  def _buildUI(self, layout):
    ...
    layout.addWidget(QtWidgets.QLabel("Frame Numbering:"), 0, 0, QtCore.Qt.AlignRight)
    layout.addWidget(QtWidgets.QLabel("Handles:"), 1, 0, QtCore.Qt.AlignRight)
    layout.addWidget(QtWidgets.QLabel("Include Timecode:"), 2, 0, QtCore.Qt.AlignRight)

    # Combos

    self._numberingCombo = QtWidgets.QComboBox()
    items = ("Match Source Clip", "Start At")
    self._numberingCombo.addItems(items)
    layout.addWidget(self._numberingCombo, 0, 1)

    self._handlesCombo = QtWidgets.QComboBox()
    ...
    self._customNumSpinner = QtWidgets.QSpinBox()
    ...
    self._handleLengthSpinner = QtWidgets.QSpinBox()
    ...
    tcHBox = QtWidgets.QHBoxLayout()

    self._setSrcTcCB = QtWidgets.QCheckBox("Src In")
    tcHBox.addWidget(self._setSrcTcCB)
    self._setCutTcCB = QtWidgets.QCheckBox("Dst In")
    tcHBox.addWidget(self._setCutTcCB)
    tcHBox.addStretch()

    layout.addLayout(tcHBox, 2, 1, 1, 2)

    self._includeRetimesCB = QtWidgets.QCheckBox("Durations Include Retiming")
