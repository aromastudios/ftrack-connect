...
class BuildAssetTrackAction(BuildTrackActionBase):
  ...
  def buildShotFromFiles(self, files, name, sequence, track, bin, originalTrackItem, expectedStartTime, expectedDuration, startHandle, endHandle, expectedOffset):
    ...
    if not manager or not manager.isEntityReference(entityRef, self.__context):
      ...
      return super(BuildAssetTrackAction, self).buildShotFromFiles(files, name, sequence, track, bin, originalTrackItem, expectedStartTime, expectedDuration, startHandle, endHandle, expectedOffset)
    ...
    trackItem = self._buildTrackItem(name, clip, originalTrackItem, expectedStartTime, expectedDuration, startHandle, endHandle, expectedOffset)
