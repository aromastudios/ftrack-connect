...
class ItemCreateDialog(QtWidgets.QDialog):
  ...
  def __init__(self, specification, context, embedBrowser=False, session=None,
    ...
    self._buttons = QtWidgets.QDialogButtonBox(buttons)
    ...
    self._buttons.button(QtWidgets.QDialogButtonBox.Ok).setText(l('{publish}'))
...
class ItemCreateWidget(QtWidgets.QWidget):
  ...
  def __init__(self, specification, context, parent=None, embedBrowser=False,
    ...
    if embedDetails:
      destGbox = QtWidgets.QGroupBox(l("{publish} To"))
      layout.addWidget(destGbox)
      destLayout = QtWidgets.QVBoxLayout()
    ...
    if embedDetails:
      self.itemSpreadsheet = ItemSpreadsheetWidget()
      self.itemsGbox = QtWidgets.QGroupBox("Items")
...
class ClipPublishDialog(ItemCreateDialog):
  ...
  def _drawOptions(self, layout):
    ...
    self._replaceMediaSource = QtWidgets.QCheckBox(
    ...
    self._ignorePublished = QtWidgets.QCheckBox(
  ...
  def setItems(self, items):
    ...
    self._buttons.button(QtWidgets.QDialogButtonBox.Ok).setEnabled(enabled)
